...
function OpenSeadragon(e) {
  ...
  ! function(h) {
    ...
    h.extend(h, {
        ...
        getViewer: function(e) {
            return h._viewers.get(this.getElement(e))
        },
        ...
        getElementPosition: function(e) {
            var t, i, n = new h.Point;
            i = o(e = h.getElement(e), t = "fixed" === h.getElementStyle(e).position);
            for (; i;) {
                n.x += e.offsetLeft;
                n.y += e.offsetTop;
                t && (n = n.plus(h.getPageScroll()));
                i = o(e = i, t = "fixed" === h.getElementStyle(e).position)
            }
            return n
        },
        getElementOffset: function(e) {
            var t, i, n = (e = h.getElement(e)) && e.ownerDocument,
                o = {
                    top: 0,
                    left: 0
                };
            if (!n) return new h.Point;
            t = n.documentElement;
            void 0 !== e.getBoundingClientRect && (o = e.getBoundingClientRect());
            i = n === n.window ? n : 9 === n.nodeType && (n.defaultView || n.parentWindow);
            return new h.Point(o.left + (i.pageXOffset || t.scrollLeft) - (t.clientLeft || 0), o.top + (i.pageYOffset || t.scrollTop) - (t.clientTop || 0))
        },
        getElementSize: function(e) {
            e = h.getElement(e);
            return new h.Point(e.clientWidth, e.clientHeight)
        },
        getElementStyle: document.documentElement.currentStyle ? function(e) {
            return (e = h.getElement(e)).currentStyle
        } : function(e) {
            e = h.getElement(e);
        ...
        getCssPropertyWithVendorPrefix: function(e) {
            var a = {};
            h.getCssPropertyWithVendorPrefix = function(e) {
                ...
                if (void 0 !== t[e]) i = e;
                    ...
                    var o = h.capitalizeFirstLetter(e);
            ...
            return h.getCssPropertyWithVendorPrefix(e)
        },
        ...
        pointInElement: function(e, t) {
            e = h.getElement(e);
            var i = h.getElementOffset(e),
                n = h.getElementSize(e);
            return t.x >= i.x && t.x < i.x + n.x && t.y < i.y + n.y && t.y >= i.y
        },
        getMousePosition: function(e) {
            if ("number" == typeof e.pageX) h.getMousePosition = function(e) {
                var t = new h.Point;
                t.x = e.pageX;
                t.y = e.pageY;
                return t
            ...
            return h.getMousePosition(e)
        },
        getPageScroll: function() {
            var e = document.documentElement || {},
                t = document.body || {};
            if ("number" == typeof window.pageXOffset) h.getPageScroll = function() {
                return new h.Point(window.pageXOffset, window.pageYOffset)
            };
            else if (t.scrollLeft || t.scrollTop) h.getPageScroll = function() {
                return new h.Point(document.body.scrollLeft, document.body.scrollTop)
            };
            else {
                if (!e.scrollLeft && !e.scrollTop) return new h.Point(0, 0);
                h.getPageScroll = function() {
                    return new h.Point(document.documentElement.scrollLeft, document.documentElement.scrollTop)
                }
            }
            return h.getPageScroll()
        },
        setPageScroll: function(e) {
            if (void 0 !== window.scrollTo) h.setPageScroll = function(e) {
                window.scrollTo(e.x, e.y)
            };
            else {
                var t = h.getPageScroll();
                if (t.x === e.x && t.y === e.y) return;
                document.body.scrollLeft = e.x;
                document.body.scrollTop = e.y;
                var i = h.getPageScroll();
                if (i.x !== t.x && i.y !== t.y) {
                    h.setPageScroll = function(e) {
                        document.body.scrollLeft = e.x;
                        document.body.scrollTop = e.y
                    };
                    return
                ...
                if ((i = h.getPageScroll()).x !== t.x && i.y !== t.y) {
                    h.setPageScroll = function(e) {
                        document.documentElement.scrollLeft = e.x;
                        document.documentElement.scrollTop = e.y
                    };
        ...
        getWindowSize: function() {
            var e = document.documentElement || {},
                t = document.body || {};
            if ("number" == typeof window.innerWidth) h.getWindowSize = function() {
                return new h.Point(window.innerWidth, window.innerHeight)
            };
            else if (e.clientWidth || e.clientHeight) h.getWindowSize = function() {
                return new h.Point(document.documentElement.clientWidth, document.documentElement.clientHeight)
            };
            else {
                if (!t.clientWidth && !t.clientHeight) throw new Error("Unknown window size, no known technique.");
                h.getWindowSize = function() {
                    return new h.Point(document.body.clientWidth, document.body.clientHeight)
                }
            }
            return h.getWindowSize()
        },
        makeCenteredNode: function(e) {
            e = h.getElement(e);
            var t = [h.makeNeutralElement("div"), h.makeNeutralElement("div"), h.makeNeutralElement("div")];
            h.extend(t[0].style, {
                display: "table",
                height: "100%",
                width: "100%"
        ...
        now: function() {
            Date.now ? h.now = Date.now : h.now = function() {
                return (new Date).getTime()
            };
            return h.now()
        },
        makeTransparentImage: function(e) {
            var t = h.makeNeutralElement("img");
            t.src = e;
            return t
        },
        setElementOpacity: function(e, t, i) {
            var n;
            e = h.getElement(e);
            i && !h.Browser.alpha && (t = Math.round(t));
            if (h.Browser.opacity) e.style.opacity = t < 1 ? t : "";
            else if (t < 1) {
        ...
        setElementTouchActionNone: function(e) {
            void 0 !== (e = h.getElement(e)).style.touchAction ? e.style.touchAction = "none" : void 0 !== e.style.msTouchAction && (e.style.msTouchAction = "none")
        },
        setElementPointerEvents: function(e, t) {
            void 0 !== (e = h.getElement(e)).style.pointerEvents && (e.style.pointerEvents = t)
        },
        setElementPointerEventsNone: function(e) {
            h.setElementPointerEvents(e, "none")
        },
        addClass: function(e, t) {
            (e = h.getElement(e)).className ? -1 === (" " + e.className + " ").indexOf(" " + t + " ") && (e.className += " " + t) : e.className = t
        },
        ...
        removeClass: function(e, t) {
            var i, n, o = [];
            i = (e = h.getElement(e)).className.split(/\s+/);
            for (n = 0; n < i.length; n++) i[n] && i[n] !== t && o.push(i[n]);
            e.className = o.join(" ")
        },
        normalizeEventListenerOptions: function(e) {
            return void 0 !== e ? "boolean" == typeof e ? h.supportsEventListenerOptions ? {
                capture: e
            } : e : h.supportsEventListenerOptions ? e : void 0 !== e.capture && e.capture : !!h.supportsEventListenerOptions && {
                capture: !1
            }
        },
        addEvent: function() {
            if (h.supportsAddEventListener) return function(e, t, i, n) {
                n = h.normalizeEventListenerOptions(n);
                (e = h.getElement(e)).addEventListener(t, i, n)
            };
            if (document.documentElement.attachEvent && document.attachEvent) return function(e, t, i) {
                (e = h.getElement(e)).attachEvent("on" + t, i)
            };
            throw new Error("No known event model.")
        }(),
        removeEvent: function() {
            if (h.supportsRemoveEventListener) return function(e, t, i, n) {
                n = h.normalizeEventListenerOptions(n);
                (e = h.getElement(e)).removeEventListener(t, i, n)
            };
            if (document.documentElement.detachEvent && document.detachEvent) return function(e, t, i) {
                (e = h.getElement(e)).detachEvent("on" + t, i)
            };
            throw new Error("No known event model.")
        }(),
        ...
        createAjaxRequest: function(e) {
            ...
            if (t) window.XMLHttpRequest ? h.createAjaxRequest = function(e) {
                return e ? new ActiveXObject("Microsoft.XMLHTTP") : new XMLHttpRequest
            } : h.createAjaxRequest = function() {
        ...
        makeAjaxRequest: function(e, t, i) {
            ...
            var s = h.getUrlProtocol(e);
            var a = h.createAjaxRequest("file:" === s);
            if (!h.isFunction(t)) throw new Error("makeAjaxRequest requires a success callback");
            a.onreadystatechange = function() {
                if (4 === a.readyState) {
                    a.onreadystatechange = function() {};
                    if (200 <= a.status && a.status < 300 || 0 === a.status && "http:" !== s && "https:" !== s) t(a);
                    else {
                        h.console.log("AJAX request returned %d: %s", a.status, e);
                        h.isFunction(i) && i(a)
                    }
                }
            };
            try {
                ...
                h.console.log("%s while making AJAX request: %s", e.name, e.message);
                a.onreadystatechange = function() {};
                h.isFunction(i) && i(a, e)
            }
            return a
        },
        jsonp: function(e) {
            var i, t = e.url,
                ...
                o = e.callbackName || "openseadragon" + h.now(),
                r = window[o],
                s = "$1" + o + "$2",
                a = e.param || "callback",
                l = e.callback;
        ...
        parseXml: function(e) {
            if (window.DOMParser) h.parseXml = function(e) {
        ...
        parseJSON: function(e) {
            h.parseJSON = window.JSON.parse;
            return h.parseJSON(e)
        },
        ...
        switch (navigator.appName) {
            case "Microsoft Internet Explorer":
                if (window.attachEvent && window.ActiveXObject) {
                    h.Browser.vendor = h.BROWSERS.IE;
                    h.Browser.version = parseFloat(t.substring(t.indexOf("MSIE") + 5, t.indexOf(";", t.indexOf("MSIE"))))
                }
                break;
            case "Netscape":
                if (window.addEventListener)
                    if (0 <= t.indexOf("Edge")) {
                        h.Browser.vendor = h.BROWSERS.EDGE;
                        h.Browser.version = parseFloat(t.substring(t.indexOf("Edge") + 5))
                    } else if (0 <= t.indexOf("Edg")) {
                    h.Browser.vendor = h.BROWSERS.CHROMEEDGE;
                    h.Browser.version = parseFloat(t.substring(t.indexOf("Edg") + 4))
                } else if (0 <= t.indexOf("Firefox")) {
                    h.Browser.vendor = h.BROWSERS.FIREFOX;
                    h.Browser.version = parseFloat(t.substring(t.indexOf("Firefox") + 8))
                } else if (0 <= t.indexOf("Safari")) {
                    h.Browser.vendor = 0 <= t.indexOf("Chrome") ? h.BROWSERS.CHROME : h.BROWSERS.SAFARI;
                    h.Browser.version = parseFloat(t.substring(t.substring(0, t.indexOf("Safari")).lastIndexOf("/") + 1, t.indexOf("Safari")))
                } else if (null !== new RegExp("Trident/.*rv:([0-9]{1,}[.0-9]{0,})").exec(t)) {
                    h.Browser.vendor = h.BROWSERS.IE;
                    h.Browser.version = parseFloat(RegExp.$1)
                }
                break;
            case "Opera":
                h.Browser.vendor = h.BROWSERS.OPERA;
                h.Browser.version = parseFloat(e)
        }
        var i, n, o, r = window.location.search.substring(1).split("&");
        for (o = 0; o < r.length; o++)
            if (0 < (n = (i = r[o]).indexOf("="))) {
                var s = i.substring(0, n),
                    a = i.substring(n + 1);
                try {
                    l[s] = decodeURIComponent(a)
                } catch (e) {
                    h.console.error("Ignoring malformed URL parameter: %s=%s", s, a)
                }
            }
        h.Browser.alpha = !(h.Browser.vendor === h.BROWSERS.CHROME && h.Browser.version < 2);
        h.Browser.opacity = !0;
        h.Browser.vendor === h.BROWSERS.IE && h.Browser.version < 11 && h.console.error("Internet Explorer versions < 11 are not supported by OpenSeadragon")
    }();
    ! function(e) {
        ...
        if (t && i) {
            ...
            h.cancelAnimationFrame = function() {
  ...
  ! function(u) {
    ...
    u.MouseTracker = function(e) {
        ...
        this.element = u.getElement(e.element);
        this.clickTimeThreshold = e.clickTimeThreshold || u.DEFAULT_SETTINGS.clickTimeThreshold;
        this.clickDistThreshold = e.clickDistThreshold || u.DEFAULT_SETTINGS.clickDistThreshold;
        this.dblClickTimeThreshold = e.dblClickTimeThreshold || u.DEFAULT_SETTINGS.dblClickTimeThreshold;
        this.dblClickDistThreshold = e.dblClickDistThreshold || u.DEFAULT_SETTINGS.dblClickDistThreshold;
        ...
        d[this.hash] = {
            click: function(e) {
                ! function(e, t) {
                    ...
                    L(e, i);
                    i.preventDefault && !i.defaultPrevented && u.cancelEvent(t);
                    i.stopPropagation && u.stopEvent(t)
                }(i, e)
            },
            dblclick: function(e) {
                ! function(e, t) {
            ...
            keydown: function(e) {
                ! function(e, t) {
                    ...
                    if (e.keyDownHandler && !n.preventGesture && !n.defaultPrevented) {
                        ...
                        e.keyDownHandler(i)
                    }(i && i.preventDefault || n.preventDefault && !n.defaultPrevented) && u.cancelEvent(t);
                    n.stopPropagation && u.stopEvent(t)
                }(i, e)
            },
            keyup: function(e) {
                ! function(e, t) {
            ...
            losecapture: function(e) {
                ! function(e, t) {
                    var i = {
                        id: u.MouseTracker.mousePointerId,
                        type: "mouse"
                    };
                    var n = {
                        originalEvent: t,
            ...
            touchstart: function(e) {
                ! function(e, t) {
                    ...
                    i = u.now();
                    s.getLength() > t.touches.length - r && u.console.warn("Tracked touch contact count doesn't match event.touches.length");
                    var a = {
                        originalEvent: t,
                    ...
                    for (n = 0; n < r; n++) {
                        o = {
                            ...
                            currentPos: w(t.changedTouches[n]),
                            currentTime: i
                        };
                        M(e, a, o);
                        A(e, a, o, 0);
                    ...
                    a.preventDefault && !a.defaultPrevented && u.cancelEvent(t);
                    a.stopPropagation && u.stopEvent(t)
                }(i, e)
            },
            touchend: function(e) {
                ! function(e, t) {
                    ...
                    s.preventDefault && !s.defaultPrevented && u.cancelEvent(t);
                    s.stopPropagation && u.stopEvent(t)
                }(i, e)
            },
            ...
            touchcancel: function(e) {
                ! function(e, t) {
                    ...
                    r.stopPropagation && u.stopEvent(t)
                }(i, e)
            },
            gesturestart: function(e) {
                !(t = e, void(u.eventIsCanceled(t) || t.preventDefault()));
                var t
            },
            ...
            pointerupcaptured: function(e) {
                ! function(e, t) {
                    e.getActivePointersListByType(f(t)).getById(t.pointerId) && I(e, t);
                    u.stopEvent(t)
                }(i, e)
            },
            pointermovecaptured: function(e) {
                ! function(e, t) {
                    e.getActivePointersListByType(f(t)).getById(t.pointerId) && B(e, t);
                    u.stopEvent(t)
                }(i, e)
            },
            tracking: !1,
        ...
        u.MouseTracker.havePointerEvents && u.setElementPointerEvents(this.element, "auto");
        this.exitHandler && u.console.error("MouseTracker.exitHandler is deprecated. Use MouseTracker.leaveHandler instead.");
        e.startDisabled || this.setTracking(!0)
    };
    u.MouseTracker.prototype = {
        destroy: function() {
            var e;
            i(this);
            this.element = null;
        ...
        isTracking: function() {
            return d[this.hash].tracking
        },
        setTracking: function(e) {
            (e ? function(e) {
                var t, i, n = d[e.hash];
                if (!n.tracking) {
                    for (i = 0; i < u.MouseTracker.subscribeEvents.length; i++) {
                        t = u.MouseTracker.subscribeEvents[i];
                        u.addEvent(e.element, t, n[t], t === u.MouseTracker.wheelEventName && {
                            passive: !1,
                            capture: !1
                        })
                    }
    ...
    u.MouseTracker.gesturePointVelocityTracker = (l = [], c = h = 0, {
    ...
    var l, h, c;
    u.MouseTracker.captureElement = document;
    u.MouseTracker.wheelEventName = u.Browser.vendor === u.BROWSERS.IE && 8 < u.Browser.version || "onwheel" in document.createElement("div") ? "wheel" : void 0 !== document.onmousewheel ? "mousewheel" : "DOMMouseScroll";
    u.MouseTracker.subscribeEvents = ["click", "dblclick", "keydown", "keyup", "keypress", "focus", "blur", "contextmenu", u.MouseTracker.wheelEventName];
    "DOMMouseScroll" === u.MouseTracker.wheelEventName && u.MouseTracker.subscribeEvents.push("MozMousePixelScroll");
    if (window.PointerEvent) {
        u.MouseTracker.havePointerEvents = !0;
        u.MouseTracker.subscribeEvents.push("pointerenter", "pointerleave", "pointerover", "pointerout", "pointerdown", "pointerup", "pointermove", "pointercancel");
        u.MouseTracker.havePointerCapture = (t = document.createElement("div"), u.isFunction(t.setPointerCapture) && u.isFunction(t.releasePointerCapture));
        u.MouseTracker.havePointerCapture && u.MouseTracker.subscribeEvents.push("gotpointercapture", "lostpointercapture")
    } else {
        u.MouseTracker.havePointerEvents = !1;
        u.MouseTracker.subscribeEvents.push("mouseenter", "mouseleave", "mouseover", "mouseout", "mousedown", "mouseup", "mousemove");
        u.MouseTracker.mousePointerId = "legacy-mouse";
        u.MouseTracker.havePointerCapture = (e = document.createElement("div"), u.isFunction(e.setCapture) && u.isFunction(e.releaseCapture));
        u.MouseTracker.havePointerCapture && u.MouseTracker.subscribeEvents.push("losecapture");
        "ontouchstart" in window && u.MouseTracker.subscribeEvents.push("touchstart", "touchend", "touchmove", "touchcancel");
        "ongesturestart" in window && u.MouseTracker.subscribeEvents.push("gesturestart", "gesturechange")
    }
    var e;
    var t;
    u.MouseTracker.GesturePointList = function(e) {
        this._gPoints = [];
        this.type = e;
        this.buttons = 0;
        this.contacts = 0;
    ...
    u.MouseTracker.GesturePointList.prototype = {
        getLength: function() {
        ...
        addContact: function() {
            ...
            if (1 < this.contacts && ("mouse" === this.type || "pen" === this.type)) {
                u.console.warn("GesturePointList.addContact() Implausible contacts value");
                this.contacts = 1
            }
        },
        removeContact: function() {
            --this.contacts;
            if (this.contacts < 0) {
                u.console.warn("GesturePointList.removeContact() Implausible contacts value");
                this.contacts = 0
            }
        }
    };
    ...
    function i(e) {
        ...
        if (n.tracking) {
            for (i = 0; i < u.MouseTracker.subscribeEvents.length; i++) {
                t = u.MouseTracker.subscribeEvents[i];
                u.removeEvent(e.element, t, n[t], !1)
            }
            p(e);
            n.tracking = !1
        }
    ...
    function v(e, t) {
        var i;
        var n;
        if (u.MouseTracker.havePointerCapture)
            if (u.MouseTracker.havePointerEvents) {
                if (!(n = e.getActivePointersListByType(t.type).getById(t.id)) || !n.captured) return;
                try {
                    e.element.releasePointerCapture(t.id)
                } catch (e) {}
            } else e.element.releaseCapture();
        else {
            i = g(e, u.MouseTracker.havePointerEvents ? "pointerevent" : t.type);
            r && s(window.top) && u.removeEvent(window.top, i.upName, i.upHandler, !0);
            u.removeEvent(u.MouseTracker.captureElement, i.moveName, i.moveHandler, !0);
            u.removeEvent(u.MouseTracker.captureElement, i.upName, i.upHandler, !0)
        }
        F(e, t, !1)
    }
  
    function m(e) {
        return u.MouseTracker.havePointerEvents ? e.pointerId : u.MouseTracker.mousePointerId
    }
  
    function f(e) {
        return u.MouseTracker.havePointerEvents ? e.pointerType || (u.Browser.vendor === u.BROWSERS.IE ? "mouse" : "") : "mouse"
    }
  
    function y(e) {
        return !u.MouseTracker.havePointerEvents || e.isPrimary
    }
    ...
    function x(e, t) {
        var i = u.getElementOffset(t);
        return e.minus(i)
    }
  
    function S(e, t) {
        return new u.Point((e.x + t.x) / 2, (e.y + t.y) / 2)
    }
    ...
    function E(e, t) {
        ...
        "mousewheel" === u.MouseTracker.wheelEventName ? i.deltaY = -t.wheelDelta / u.DEFAULT_SETTINGS.pixelsPerWheelLine : i.deltaY = t.detail;
        P(e, i, t)
    }
    ...
    function P(e, t, i) {
        ...
        o.stopPropagation && u.stopEvent(i);
        (r && r.preventDefault || o.preventDefault && !o.defaultPrevented) && u.cancelEvent(i)
    }
    ...
    function C(e, t) {
        ...
        ! function(e, t, i) {
            ...
            e.overHandler && e.overHandler({
                eventSource: e,
                pointerType: i.type,
                position: x(i.currentPos, e.element),
                buttons: n.buttons,
        ...
        n.preventDefault && !n.defaultPrevented && u.cancelEvent(t);
        n.stopPropagation && u.stopEvent(t)
    }
    ...
    function b(e, t) {
        ...
        ! function(e, t, i) {
            ...
            e.outHandler && e.outHandler({
                eventSource: e,
                pointerType: i.type,
                position: i.currentPos && x(i.currentPos, e.element),
                buttons: n.buttons,
                pointers: e.getActivePointerCount(),
                insideElementPressed: i.insideElementPressed,
                buttonDownAny: 0 !== n.buttons,
    ...
    function D(e, t) {
        ...
        var n = u.MouseTracker.havePointerEvents && "touch" === i.type && u.Browser.vendor !== u.BROWSERS.IE;
        var o = {
            originalEvent: t,
            eventType: "pointerdown",
            pointerType: i.type,
        ...
        L(e, o);
        A(e, o, i, t.button);
        o.preventDefault && !o.defaultPrevented && u.cancelEvent(t);
        o.stopPropagation && u.stopEvent(t);
        o.shouldCapture && (n ? F(e, i, !0) : function(e, t) {
            var i;
            if (u.MouseTracker.havePointerCapture)
                if (u.MouseTracker.havePointerEvents) try {
                    e.element.setPointerCapture(t.id)
                } catch (e) {
                    u.console.warn("setPointerCapture() called on invalid pointer ID");
                    return
                } else e.element.setCapture(!0);
                else {
                    i = g(e, u.MouseTracker.havePointerEvents ? "pointerevent" : t.type);
                    r && s(window.top) && u.addEvent(window.top, i.upName, i.upHandler, !0);
                    u.addEvent(u.MouseTracker.captureElement, i.upName, i.upHandler, !0);
                    u.addEvent(u.MouseTracker.captureElement, i.moveName, i.moveHandler, !0)
                }
            F(e, t, !0)
        }(e, i))
    }
    ...
    function I(e, t) {
        ...
        n.preventDefault && !n.defaultPrevented && u.cancelEvent(t);
        n.stopPropagation && u.stopEvent(t);
        n.shouldReleaseCapture && (t.target === e.element ? v(e, i) : F(e, i, !1))
    }
    ...
    function z(e, t, i) {
        ...
        if (o) {
            if (o.captured) {
                u.console.warn("stopTrackingPointer() called on captured pointer");
                v(e, o)
            }("mouse" === t.type || "pen" === t.type) && 0 < t.contacts && t.removeContact();
            n = t.removeById(i.id)
        } else n = t.getLength();
        return n
    }
    ...
    function L(e, t) {
        ...
        t.defaultPrevented = u.eventIsCanceled(t.originalEvent);
        t.shouldCapture = !1;
    ...
    function F(e, t, i) {
        var n = e.getActivePointersListByType(t.type);
        var o = n.getById(t.id);
        if (o) {
            if (i && !o.captured) {
                o.captured = !0;
                n.captureCount++
            } else if (!i && o.captured) {
                o.captured = !1;
                n.captureCount--;
                if (n.captureCount < 0) {
                    n.captureCount = 0;
                    u.console.warn("updatePointerCaptured() - pointsList.captureCount went negative")
                }
            }
        } else u.console.warn("updatePointerCaptured() called on untracked pointer")
    }
    ...
    function N(e, t, i) {
        var n, o, r = e.getActivePointersListByType(i.type);
        if (n = r.getById(i.id)) {
            if (n.captured) {
                n.insideElement = !1;
                n.lastPos = n.currentPos;
        ...
        if (0 === n)
            if (o = s.getById(i.id)) {
                ...
                if (t.preventGesture || t.defaultPrevented) {
                    ...
                    t.shouldReleaseCapture = !1;
                    t.preventDefault = !0;
                    (e.dragHandler || e.dragEndHandler || e.pinchHandler) && u.MouseTracker.gesturePointVelocityTracker.addPoint(e, i);
                    if (1 === s.contacts) e.pressHandler && !t.preventGesture && e.pressHandler({
                        eventSource: e,
                        pointerType: i.type,
                        position: x(i.contactPos, e.element),
                        buttons: s.buttons,
                        isTouchEvent: "touch" === i.type,
                        originalEvent: t.originalEvent,
                        userData: e.userData
                        ...
                        r.lastPinchCenter = r.currentPinchCenter = S(r.pinchGPoints[0].currentPos, r.pinchGPoints[1].currentPos)
                    }
                }
            } else {
                u.console.warn("pointerdown event on untracked pointer");
                i.captured = !1;
    ...
    function W(e, t, i, n) {
        var o, r, s, a, l = d[e.hash],
            h = e.getActivePointersListByType(i.type),
            c = !1;
        void 0 !== t.originalEvent.buttons ? h.buttons = t.originalEvent.buttons : 0 === n ? h.buttons ^= -2 : 1 === n ? h.buttons ^= -5 : 2 === n ? h.buttons ^= -3 : 3 === n ? h.buttons ^= -9 : 4 === n ? h.buttons ^= -17 : 5 === n && (h.buttons ^= -33);
        t.shouldCapture = !1;
        if (0 === n) {
            if (s = h.getById(i.id)) {
                h.removeContact();
                ...
                s.currentPos = i.currentPos;
                s.currentTime = i.currentTime;
                s.insideElement || z(e, h, s);
                o = s.currentPos;
                r = s.currentTime
            } else {
                u.console.warn("updatePointerUp(): pointerup on untracked gPoint");
                i.captured = !1;
                i.insideElementPressed = !1;
                i.insideElement = !0;
                H(h, i);
            ...
            if (!t.preventGesture && !t.defaultPrevented)
                if (c) {
                    ...
                    t.preventDefault = !0;
                    (e.dragHandler || e.dragEndHandler || e.pinchHandler) && u.MouseTracker.gesturePointVelocityTracker.removePoint(e, s);
                    if (0 === h.contacts) {
                        e.releaseHandler && e.releaseHandler({
                            eventSource: e,
                            pointerType: s.type,
                            position: x(o, e.element),
                            buttons: h.buttons,
                            insideElementPressed: s.insideElementPressed,
                            insideElementReleased: s.insideElement,
                            isTouchEvent: "touch" === s.type,
                            originalEvent: t.originalEvent,
                            userData: e.userData
                        });
                        e.dragEndHandler && l.sentDragEvent && e.dragEndHandler({
                            eventSource: e,
                            pointerType: s.type,
                            position: x(s.currentPos, e.element),
                            speed: s.speed,
                        ...
                        l.sentDragEvent = !1;
                        if ((e.clickHandler || e.dblClickHandler) && s.insideElement) {
                            a = r - s.contactTime <= e.clickTimeThreshold && s.contactPos.distanceTo(o) <= e.clickDistThreshold;
                            ...
                            if (e.dblClickHandler && a) {
                                h.clicks++;
                                if (1 === h.clicks) {
                                    l.lastClickPos = o;
                                    l.dblClickTimeOut = setTimeout(function() {
                                        h.clicks = 0
                                    }, e.dblClickTimeThreshold)
                                } else if (2 === h.clicks) {
                                    clearTimeout(l.dblClickTimeOut);
                                    h.clicks = 0;
                                    l.lastClickPos.distanceTo(o) <= e.dblClickDistThreshold && e.dblClickHandler({
                                        eventSource: e,
                                        pointerType: s.type,
                                        position: x(s.currentPos, e.element),
                                        shift: t.originalEvent.shiftKey,
                    ...
                    } else if (2 === h.contacts && e.pinchHandler && "touch" === s.type) {
                        l.pinchGPoints = h.asArray();
                        l.lastPinchDist = l.currentPinchDist = l.pinchGPoints[0].currentPos.distanceTo(l.pinchGPoints[1].currentPos);
                        l.lastPinchCenter = l.currentPinchCenter = S(l.pinchGPoints[0].currentPos, l.pinchGPoints[1].currentPos)
                    }
                } else {
                    t.shouldReleaseCapture = !1;
                    if (e.releaseHandler) {
    ...
    function V(n, o, r) {
        var e, t, i, s = d[n.hash],
            a = n.getActivePointersListByType(r.type);
        void 0 !== o.originalEvent.buttons && (a.buttons = o.originalEvent.buttons);
        if (e = a.getById(r.id)) {
            ...
            if (0 === a.contacts) n.moveHandler && n.moveHandler({
                eventSource: n,
                pointerType: r.type,
                position: x(r.currentPos, n.element),
                buttons: a.buttons,
                isTouchEvent: "touch" === r.type,
                originalEvent: o.originalEvent,
                userData: n.userData
            });
            else if (1 === a.contacts) {
                if (n.moveHandler) {
                    e = a.asArray()[0];
                    n.moveHandler({
                        eventSource: n,
                        pointerType: e.type,
                        position: x(e.currentPos, n.element),
                        buttons: a.buttons,
                ...
                if (n.dragHandler && !o.preventGesture && !o.defaultPrevented) {
                    i = (e = a.asArray()[0]).currentPos.minus(e.lastPos);
                    n.dragHandler({
                        eventSource: n,
                        pointerType: e.type,
                        position: x(e.currentPos, n.element),
            ...
            } else if (2 === a.contacts) {
                if (n.moveHandler) {
                    t = a.asArray();
                    n.moveHandler({
                        eventSource: n,
                        pointerType: t[0].type,
                        position: x(S(t[0].currentPos, t[1].currentPos), n.element),
                        buttons: a.buttons,
                        isTouchEvent: "touch" === t[0].type,
                        originalEvent: o.originalEvent,
                        userData: n.userData
                    })
                }
                if (n.pinchHandler && "touch" === r.type && !o.preventGesture && !o.defaultPrevented && (i = s.pinchGPoints[0].currentPos.distanceTo(s.pinchGPoints[1].currentPos)) !== s.currentPinchDist) {
                    s.lastPinchDist = s.currentPinchDist;
                    s.currentPinchDist = i;
                    s.lastPinchCenter = s.currentPinchCenter;
                    s.currentPinchCenter = S(s.pinchGPoints[0].currentPos, s.pinchGPoints[1].currentPos);
                    n.pinchHandler({
                        eventSource: n,
                        pointerType: "touch",
                        gesturePoints: s.pinchGPoints,
                        lastCenter: x(s.lastPinchCenter, n.element),
                        center: x(s.currentPinchCenter, n.element),
  ...
  ! function(v) {
    ...
    v.Viewer = function(e) {
        ...
        v.extend(!0, this, {
            ...
            buttons: null,
            profiler: null
        }, v.DEFAULT_SETTINGS, e);
        if (void 0 === this.hash) throw new Error("A hash must be defined, either by specifying options.id or options.hash.");
        void 0 !== c[this.hash] && v.console.warn("Hash " + this.hash + " has already been used.");
        c[this.hash] = {
            fsBoundsDelta: new v.Point(1, 1),
        ...
        this._lastScrollTime = v.now();
        v.EventSource.call(this);
        this.addHandler("open-failed", function(e) {
            var t = v.getString("Errors.OpenFailed", e.eventSource, e.message);
            n._showMessage(t)
        });
        v.ControlDock.call(this, e);
        this.xmlPath && (this.tileSources = [this.xmlPath]);
        this.element = this.element || document.getElementById(this.id);
        this.canvas = v.makeNeutralElement("div");
        ...
        v.setElementTouchActionNone(this.canvas);
        ...
        v.setElementTouchActionNone(this.container);
        ...
        this.innerTracker = new v.MouseTracker({
            ...
            contextMenuHandler: v.delegate(this, l),
            keyDownHandler: v.delegate(this, g),
            keyHandler: v.delegate(this, y),
            clickHandler: v.delegate(this, w),
            dblClickHandler: v.delegate(this, T),
            dragHandler: v.delegate(this, x),
            dragEndHandler: v.delegate(this, S),
            enterHandler: v.delegate(this, E),
            leaveHandler: v.delegate(this, P),
            pressHandler: v.delegate(this, R),
            releaseHandler: v.delegate(this, _),
            nonPrimaryPressHandler: v.delegate(this, C),
            nonPrimaryReleaseHandler: v.delegate(this, b),
            scrollHandler: v.delegate(this, O),
            pinchHandler: v.delegate(this, D)
        });
        this.outerTracker = new v.MouseTracker({
            ...
            dblClickTimeThreshold: this.dblClickTimeThreshold,
            dblClickDistThreshold: this.dblClickDistThreshold,
            enterHandler: v.delegate(this, I),
            leaveHandler: v.delegate(this, k)
        });
        this.toolbar && (this.toolbar = new v.ControlDock({
            element: this.toolbar
        }));
        this.bindStandardControls();
        c[this.hash].prevContainerSize = u(this.container);
        this.world = new v.World({
            viewer: this
        });
        ...
        this.imageLoader = new v.ImageLoader({
            jobLimit: this.imageLoaderLimit,
            timeout: e.timeout
        });
        this.tileCache = new v.TileCache({
        ...
        this.overlaysContainer = v.makeNeutralElement("div");
        ...
        this.showNavigator && (this.navigator = new v.Navigator({
            id: this.navigatorId,
        ...
        v._viewers.set(this.element, this)
    };
    v.extend(v.Viewer.prototype, v.EventSource.prototype, v.ControlDock.prototype, {
        isOpen: function() {
            return !!this.world.getItemCount()
        },
        openDzi: function(e) {
            v.console.error("[Viewer.openDzi] this function is deprecated; use Viewer.open() instead.");
            return this.open(e)
        },
        openTileSource: function(e) {
            v.console.error("[Viewer.openTileSource] this function is deprecated; use Viewer.open() instead.");
            return this.open(e)
        },
        open: function(i, e) {
            var o = this;
            this.close();
            if (!i) return this;
            if (this.sequenceMode && v.isArray(i)) {
                ...
                if (r + s === n)
                    if (r) {
                        ...
                        if (o.overlays && !o.preserveOverlays)
                            for (var t = 0; t < o.overlays.length; t++) o.currentOverlays[t] = h(o, o.overlays[t]);
                        o._drawOverlays();
                        o._opening = !1;
                        o.raiseEvent("open", {
                            source: e
            ...
            for (var t = 0; t < i.length; t++) ! function(i) {
                v.isPlainObject(i) && i.tileSource || (i = {
                    tileSource: i
                });
                if (void 0 !== i.index) {
                    v.console.error("[Viewer.open] setting indexes here is not supported; use addTiledImage instead");
                    delete i.index
                }
                ...
                i.success = function(e) {
                    ...
                    if (i.tileSource.overlays)
                        for (var t = 0; t < i.tileSource.overlays.length; t++) o.addOverlay(i.tileSource.overlays[t]);
                    n && n(e);
                    l()
                };
                var t = i.error;
        ...
        destroy: function() {
            if (c[this.hash]) {
                ...
                this.canvas = null;
                this.container = null;
                v._viewers.delete(this.element);
                this.element = null
            }
        },
        ...
        setFullPage: function(e) {
            ...
            if (e) {
                this.elementSize = v.getElementSize(this.element);
                this.pageScroll = v.getPageScroll();
                ...
                if (this.toolbar && this.toolbar.element) {
                    ...
                    v.addClass(this.toolbar.element, "fullpage")
                }
                v.addClass(this.element, "fullpage");
                n.appendChild(this.element);
                this.element.style.height = v.getWindowSize().y + "px";
                this.element.style.width = v.getWindowSize().x + "px";
                this.toolbar && this.toolbar.element && (this.element.style.height = v.getElementSize(this.element).y - v.getElementSize(this.toolbar.element).y + "px");
                ...
                var l = 0;
                var h = function() {
                    v.setPageScroll(s.pageScroll);
                    var e = v.getPageScroll();
                    ++l < 10 && (e.x !== s.pageScroll.x || e.y !== s.pageScroll.y) && v.requestAnimationFrame(h)
                };
        ...
        setFullScreen: function(e) {
            var t = this;
            if (!v.supportsFullScreen) return this.setFullPage(e);
            if (v.isFullScreen() === e) return this;
            var i = {
                fullScreen: e,
                preventDefaultAction: !1
            };
            ...
            if (e) {
                ...
                this.element.style.height = "100%";
                var n = function() {
                    var e = v.isFullScreen();
                    if (!e) {
                        v.removeEvent(document, v.fullScreenEventName, n);
                        v.removeEvent(document, v.fullScreenErrorEventName, n);
                        t.setFullPage(!1);
                        if (t.isFullPage()) {
                ...
                v.addEvent(document, v.fullScreenEventName, n);
                v.addEvent(document, v.fullScreenErrorEventName, n);
                v.requestFullScreen(document.body)
            } else v.exitFullScreen();
            return this
        },
        isVisible: function() {
        ...
        addTiledImage: function(i) {
            v.console.assert(i, "[Viewer.addTiledImage] options is required");
            v.console.assert(i.tileSource, "[Viewer.addTiledImage] options.tileSource is required");
            v.console.assert(!i.replace || -1 < i.index && i.index < this.world.getItemCount(), "[Viewer.addTiledImage] if options.replace is used, options.index must be a valid index in Viewer.world");
            var o = this;
            ...
            void 0 === i.ajaxHeaders || null === i.ajaxHeaders ? i.ajaxHeaders = this.ajaxHeaders : v.isPlainObject(i.ajaxHeaders) && v.isPlainObject(this.ajaxHeaders) && (i.ajaxHeaders = v.extend({}, this.ajaxHeaders, i.ajaxHeaders));
            var n = {
                options: i
            };
  
            function t(e) {
                for (var t = 0; t < o._loadQueue.length; t++)
                    if (o._loadQueue[t] === n) {
            ...
            if (v.isArray(i.tileSource)) setTimeout(function() {
                t({
                ...
                ! function(n, o, r, s, a) {
                    var l = n;
                    if ("string" === v.type(o))
                        if (o.match(/^\s*<.*>\s*$/)) o = v.parseXml(o);
                        else if (o.match(/^\s*[{[].*[}\]]\s*$/)) try {
                        var e = v.parseJSON(o);
                        o = e
                    } catch (e) {}
                    ...
                    setTimeout(function() {
                        if ("string" === v.type(o))(o = new v.TileSource({
                            url: o,
                            ...
                            ajaxHeaders: r.ajaxHeaders ? r.ajaxHeaders : n.ajaxHeaders,
                        ...
                        else if (v.isPlainObject(o) || o.nodeType) {
                            ...
                            if (v.isFunction(o.getTileUrl)) {
                                var e = new v.TileSource(o);
                                e.getTileUrl = o.getTileUrl;
                                s(e)
                            } else {
                                var t = v.TileSource.determineType(l, o);
                                if (!t) {
                                    a({
            ...
            function s() {
                ...
                for (; o._loadQueue.length && (e = o._loadQueue[0]).tileSource;) {
                    ...
                    if (e.options.replace) {
                        var n = o.world.getIndexOfItem(e.options.replaceItem); - 1 !== n && (e.options.index = n);
        ...
        addSimpleImage: function(e) {
            v.console.assert(e, "[Viewer.addSimpleImage] options is required");
            v.console.assert(e.url, "[Viewer.addSimpleImage] options.url is required");
            var t = v.extend({}, e, {
                tileSource: {
                    type: "image",
                    url: e.url
        ...
        addLayer: function(t) {
            var i = this;
            v.console.error("[Viewer.addLayer] this function is deprecated; use Viewer.addTiledImage() instead.");
            var e = v.extend({}, t, {
                success: function(e) {
        ...
        getLayerAtLevel: function(e) {
            v.console.error("[Viewer.getLayerAtLevel] this function is deprecated; use World.getItemAt() instead.");
            return this.world.getItemAt(e)
        },
        getLevelOfLayer: function(e) {
            v.console.error("[Viewer.getLevelOfLayer] this function is deprecated; use World.getIndexOfItem() instead.");
            return this.world.getIndexOfItem(e)
        },
        getLayersCount: function() {
            v.console.error("[Viewer.getLayersCount] this function is deprecated; use World.getItemCount() instead.");
            return this.world.getItemCount()
        },
        setLayerLevel: function(e, t) {
            v.console.error("[Viewer.setLayerLevel] this function is deprecated; use World.setItemIndex() instead.");
            return this.world.setItemIndex(e, t)
        },
        removeLayer: function(e) {
            v.console.error("[Viewer.removeLayer] this function is deprecated; use World.removeItem() instead.");
        ...
        bindSequenceControls: function() {
            var e = v.delegate(this, m),
                t = v.delegate(this, f),
                i = v.delegate(this, this.goToNextPage),
                n = v.delegate(this, this.goToPreviousPage),
                o = this.navImages,
                r = !0;
            if (this.showSequenceControl) {
                (this.previousButton || this.nextButton) && (r = !1);
                this.previousButton = new v.Button({
                    element: this.previousButton ? v.getElement(this.previousButton) : null,
                    clickTimeThreshold: this.clickTimeThreshold,
                    clickDistThreshold: this.clickDistThreshold,
                    tooltip: v.getString("Tooltips.PreviousPage"),
                ...
                this.nextButton = new v.Button({
                    element: this.nextButton ? v.getElement(this.nextButton) : null,
                    clickTimeThreshold: this.clickTimeThreshold,
                    clickDistThreshold: this.clickDistThreshold,
                    tooltip: v.getString("Tooltips.NextPage"),
                ...
                if (r) {
                    ...
                    this.toolbar ? this.toolbar.addControl(this.pagingControl, {
                        anchor: v.ControlAnchor.BOTTOM_RIGHT
                    }) : this.addControl(this.pagingControl, {
                        anchor: this.sequenceControlAnchor || v.ControlAnchor.TOP_LEFT
                    })
                }
            }
            return this
        ...
        bindStandardControls: function() {
            ...
            if (this.showNavigationControl) {
                ...
                if (this.showZoomControl) {
                    p.push(this.zoomInButton = new v.Button({
                        element: this.zoomInButton ? v.getElement(this.zoomInButton) : null,
                        clickTimeThreshold: this.clickTimeThreshold,
                        clickDistThreshold: this.clickDistThreshold,
                        tooltip: v.getString("Tooltips.ZoomIn"),
                    ...
                    p.push(this.zoomOutButton = new v.Button({
                        element: this.zoomOutButton ? v.getElement(this.zoomOutButton) : null,
                        clickTimeThreshold: this.clickTimeThreshold,
                        clickDistThreshold: this.clickDistThreshold,
                        tooltip: v.getString("Tooltips.ZoomOut"),
                ...
                this.showHomeControl && p.push(this.homeButton = new v.Button({
                    element: this.homeButton ? v.getElement(this.homeButton) : null,
                    clickTimeThreshold: this.clickTimeThreshold,
                    clickDistThreshold: this.clickDistThreshold,
                    tooltip: v.getString("Tooltips.Home"),
                ...
                this.showFullPageControl && p.push(this.fullPageButton = new v.Button({
                    element: this.fullPageButton ? v.getElement(this.fullPageButton) : null,
                    clickTimeThreshold: this.clickTimeThreshold,
                    clickDistThreshold: this.clickDistThreshold,
                    tooltip: v.getString("Tooltips.FullPage"),
                ...
                if (this.showRotationControl) {
                    p.push(this.rotateLeftButton = new v.Button({
                        element: this.rotateLeftButton ? v.getElement(this.rotateLeftButton) : null,
                        clickTimeThreshold: this.clickTimeThreshold,
                        clickDistThreshold: this.clickDistThreshold,
                        tooltip: v.getString("Tooltips.RotateLeft"),
                    ...
                    p.push(this.rotateRightButton = new v.Button({
                        element: this.rotateRightButton ? v.getElement(this.rotateRightButton) : null,
                        clickTimeThreshold: this.clickTimeThreshold,
                        clickDistThreshold: this.clickDistThreshold,
                        tooltip: v.getString("Tooltips.RotateRight"),
                ...
                this.showFlipControl && p.push(this.flipButton = new v.Button({
                    element: this.flipButton ? v.getElement(this.flipButton) : null,
                    clickTimeThreshold: this.clickTimeThreshold,
                    clickDistThreshold: this.clickDistThreshold,
                    tooltip: v.getString("Tooltips.Flip"),
                ...
                if (g) {
                    this.buttonGroup = new v.ButtonGroup({
                        buttons: p,
                        clickTimeThreshold: this.clickTimeThreshold,
                        clickDistThreshold: this.clickDistThreshold
                    });
                    this.navControl = this.buttonGroup.element;
                    this.addHandler("open", v.delegate(this, A));
                    this.toolbar ? this.toolbar.addControl(this.navControl, {
                        anchor: this.navigationControlAnchor || v.ControlAnchor.TOP_LEFT
        ...
        addOverlay: function(e, t, i, n) {
            var o;
            o = v.isPlainObject(e) ? e : {
                element: e,
                location: t,
                placement: i,
                onDraw: n
            };
            e = v.getElement(o.element);
        ...
        _showMessage: function(e) {
            this._hideMessage();
            var t = v.makeNeutralElement("div");
            t.appendChild(document.createTextNode(e));
            this.messageDiv = v.makeCenteredNode(t);
            v.addClass(this.messageDiv, "openseadragon-message");
        ...
        addReferenceStrip: function() {
            ...
            if (this.sequenceMode) {
                ...
                if (this.tileSources.length && 1 < this.tileSources.length) {
                    this.referenceStrip = new v.ReferenceStrip({
            ...
            } else v.console.warn('Attempting to display a reference strip while "sequenceMode" is off.')
        },
        _addUpdatePixelDensityRatioEvent: function() {
            this._updatePixelDensityRatioBind = this._updatePixelDensityRatio.bind(this);
            v.addEvent(window, "resize", this._updatePixelDensityRatioBind)
        },
        _removeUpdatePixelDensityRatioEvent: function() {
            v.removeEvent(window, "resize", this._updatePixelDensityRatioBind)
        },
        _updatePixelDensityRatio: function() {
            var e = v.pixelDensityRatio;
            var t = v.getCurrentPixelDensityRatio();
            if (e !== t) {
                v.pixelDensityRatio = t;
    ...
    function u(e) {
        e = v.getElement(e);
        return new v.Point(0 === e.clientWidth ? 1 : e.clientWidth, 0 === e.clientHeight ? 1 : e.clientHeight)
    }
  
    function h(e, t) {
        if (t instanceof v.Overlay) return t;
        var i = null;
        if (t.element) i = v.getElement(t.element);
        else {
            var n = t.id ? t.id : "openseadragon-overlay-" + Math.floor(1e7 * Math.random());
            (i = v.getElement(t.id)) || ((i = document.createElement("a")).href = "#/overlay/" + n);
            i.id = n;
            v.addClass(i, t.className ? t.className : "openseadragon-overlay")
        }
        var o = t.location;
        var r = t.width;
        var s = t.height;
        if (!o) {
            ...
            var l = t.y;
            if (void 0 !== t.px) {
                var h = e.viewport.imageToViewportRectangle(new v.Rect(t.px, t.py, r || 0, s || 0));
                a = h.x;
                l = h.y;
        ...
        var c = t.placement;
        c && "string" === v.type(c) && (c = v.Placement[t.placement.toUpperCase()]);
        return new v.Overlay({
            element: i,
            location: o,
            placement: c,
            onDraw: t.onDraw,
    ...
    function d(e) {
        if (e.autoHideControls) {
            ...
            e.controlsFadeBeginTime = v.now() + e.controlsFadeDelay;
        ...
        if (t.preventDefaultAction || e.ctrl || e.alt || e.meta) e.preventDefault = !1;
            ...
            case 38:
                if (!t.preventVerticalPan) {
                    e.shift ? this.viewport.zoomBy(1.1) : this.viewport.panBy(this.viewport.deltaPointsFromPixels(new v.Point(0, -this.pixelsPerArrowPress)));
            ...
            case 40:
                if (!t.preventVerticalPan) {
                    e.shift ? this.viewport.zoomBy(.9) : this.viewport.panBy(this.viewport.deltaPointsFromPixels(new v.Point(0, this.pixelsPerArrowPress)));
                    this.viewport.applyConstraints()
                }
                e.preventDefault = !0;
                break;
            case 37:
                if (!t.preventHorizontalPan) {
                    this.viewport.panBy(this.viewport.deltaPointsFromPixels(new v.Point(-this.pixelsPerArrowPress, 0)));
                    this.viewport.applyConstraints()
                }
                e.preventDefault = !0;
                break;
    ...
    function y(e) {
        ...
        if (t.preventDefaultAction || e.ctrl || e.alt || e.meta) e.preventDefault = !1;
            ...
            case 87:
                if (!t.preventVerticalPan) {
                    e.shift ? this.viewport.zoomBy(1.1) : this.viewport.panBy(this.viewport.deltaPointsFromPixels(new v.Point(0, -40)));
                    this.viewport.applyConstraints()
                }
                e.preventDefault = !0;
                break;
            ...
            case 83:
                if (!t.preventVerticalPan) {
                    e.shift ? this.viewport.zoomBy(.9) : this.viewport.panBy(this.viewport.deltaPointsFromPixels(new v.Point(0, 40)));
                    this.viewport.applyConstraints()
                }
                e.preventDefault = !0;
                break;
            case 97:
                if (!t.preventHorizontalPan) {
                    this.viewport.panBy(this.viewport.deltaPointsFromPixels(new v.Point(-40, 0)));
                    this.viewport.applyConstraints()
                }
                e.preventDefault = !0;
                break;
            case 100:
                ...
                break;
            case 114:
                this.viewport.flipped ? this.viewport.setRotation(v.positiveModulo(this.viewport.degrees - this.rotationIncrement, 360)) : this.viewport.setRotation(v.positiveModulo(this.viewport.degrees + this.rotationIncrement, 360));
                this.viewport.applyConstraints();
                e.preventDefault = !0;
                break;
            case 82:
    ...
    function S(e) {
        ...
        if (!t.preventDefaultAction && this.viewport) {
            ...
            if (i.flickEnabled && e.speed >= i.flickMinSpeed) {
                ...
                var o = 0;
                this.panVertical && (o = i.flickMomentum * e.speed * Math.sin(e.direction));
                var r = this.viewport.pixelFromPoint(this.viewport.getCenter(!0));
                var s = this.viewport.pointFromPixel(new v.Point(r.x - n, r.y - o));
    ...
    function D(e) {
        ...
        if (this.viewport) {
            ...
            if (t.pinchRotate && !o.preventDefaultRotateAction) {
                ...
                var s = Math.atan2(e.gesturePoints[0].lastPos.y - e.gesturePoints[1].lastPos.y, e.gesturePoints[0].lastPos.x - e.gesturePoints[1].lastPos.x);
                this.viewport.setRotation(this.viewport.getRotation() + (r - s) * (180 / Math.PI))
            }
        }
    }
    ...
    function O(e) {
        var t, i, n, o;
        if ((o = v.now()) - this._lastScrollTime > this.minScrollDeltaTime) {
    ...
    function z() {
        c[this.hash].lastZoomTime = v.now();
    ...
    function n(e) {
        v.requestAnimationFrame(v.delegate(e, t))
    }
  
    function t() {
        var e, t, i;
        if (c[this.hash].zooming && this.viewport) {
            t = (e = v.now()) - c[this.hash].lastZoomTime;
    ...
    function V() {
        this.isFullPage() && !v.isFullScreen() ? this.setFullPage(!1) : this.setFullScreen(!this.isFullPage());
    ...
    function G() {
        if (this.viewport) {
            ...
            e = this.viewport.flipped ? v.positiveModulo(e + this.rotationIncrement, 360) : v.positiveModulo(e - this.rotationIncrement, 360);
  ...
  ! function(c) {
    c.Navigator = function(i) {
        ...
        if (i.id) {
            ...
            if (i.position)
                if ("BOTTOM_RIGHT" === i.position) i.controlOptions.anchor = c.ControlAnchor.BOTTOM_RIGHT;
                else if ("BOTTOM_LEFT" === i.position) i.controlOptions.anchor = c.ControlAnchor.BOTTOM_LEFT;
            else if ("TOP_RIGHT" === i.position) i.controlOptions.anchor = c.ControlAnchor.TOP_RIGHT;
            else if ("TOP_LEFT" === i.position) i.controlOptions.anchor = c.ControlAnchor.TOP_LEFT;
        ...
        c.setElementPointerEventsNone(this.displayRegion);
        c.setElementTouchActionNone(this.displayRegion);
        this.displayRegionContainer = c.makeNeutralElement("div");
        this.displayRegionContainer.id = this.element.id + "-displayregioncontainer";
        this.displayRegionContainer.className = "displayregioncontainer";
        this.displayRegionContainer.style.width = "100%";
        this.displayRegionContainer.style.height = "100%";
        c.setElementPointerEventsNone(this.displayRegionContainer);
        c.setElementTouchActionNone(this.displayRegionContainer);
        ...
        c.setElementPointerEventsNone(this.canvas);
        c.setElementPointerEventsNone(this.container);
    ...
    c.extend(c.Navigator.prototype, c.EventSource.prototype, c.Viewer.prototype, {
        ...
        destroy: function() {
            return c.Viewer.prototype.destroy.apply(this)
        },
  ...
  ! function(d) {
    ...
    d.TileSource.prototype = {
        ...
        getPixelRatio: function(e) {
            var t = this.dimensions.times(this.getLevelScale(e)),
                i = 1 / t.x * d.pixelDensityRatio,
                n = 1 / t.y * d.pixelDensityRatio;
            return new d.Point(i, n)
        },
    ...
    d.TileSource.determineType = function(e, t, i) {
        ...
        for (n in OpenSeadragon)
            if (n.match(/.+TileSource$/) && d.isFunction(OpenSeadragon[n]) && d.isFunction(OpenSeadragon[n].prototype.supports) && OpenSeadragon[n].prototype.supports.call(e, t, i)) return OpenSeadragon[n];
    ...
    g.extend(g.DziTileSource.prototype, g.TileSource.prototype, {
        ...
        configure: function(e, t) {
            ...
            i = (g.isPlainObject(e) ? p : function(e, t) {
                ...
                var i, n, o, r, s, a = t.documentElement,
            ...
            if (t && !i.tilesUrl) {
                i.tilesUrl = t.replace(/([^/]+?)(\.(dzi|xml|js)?(\?[^/]*)?)?\/?$/, "$1_files/"); - 1 !== t.search(/\.(dzi|xml|js)\?/) ? i.queryParams = t.match(/\?.*/) : i.queryParams = ""
            }
            return i
        },
        getTileUrl: function(e, t, i) {
        ...
        tileExists: function(e, t, i) {
            ...
            for (h = c.length - 1; 0 <= h; h--)
                if (!(e < (n = c[h]).minLevel || e > n.maxLevel)) {
  ...
  ! function(h) {
    ...
    h.extend(h.IIIFTileSource.prototype, h.TileSource.prototype, {
                ...
                if (e["@context"]) {
                    ...
                    if (Array.isArray(i))
                        for (var n = 0; n < i.length; n++)
                            if ("string" == typeof i[n] && (/^http:\/\/iiif\.io\/api\/image\/[1-3]\/context\.json$/.test(i[n]) || "http://library.stanford.edu/iiif/image-api/1.1/context.json" === i[n])) {
                                i = i[n];
                                break
                            }
                    switch (i) {
                ...
                if ("info" === i) try {
                    ! function e(t, i, n) {
                        ...
                        if (3 === t.nodeType && n) {
                            ...
                            for (o = 0; o < t.childNodes.length; o++) e(t.childNodes[o], i, t.nodeName)
                    }(t, n = {});
                    return n
                } catch (e) {
        ...
        getTileUrl: function(e, t, i) {
            ...
            var o, r, s, a, l, h, c, u, d, p, g, v, m, f = Math.pow(.5, this.maxLevel - e),
            ...
            s = Math.ceil(o / f);
            a = Math.ceil(r / f);
            m = 1 === this.version ? "native." + this.tileFormat : "default." + this.tileFormat;
            if (y < o && w < r) {
                p = 2 === this.version && y === this.width ? "full" : 3 === this.version && y === this.width && w === this.height ? "max" : 3 === this.version ? y + "," + w : y + ",";
                l = "full"
            } else {
                h = t * s;
                c = i * a;
                ...
                g = Math.ceil(u * f);
                v = Math.ceil(d * f);
                p = 2 === this.version && g === this.width ? "full" : 3 === this.version && g === this.width && v === this.height ? "max" : 3 === this.version ? g + "," + v : g + ","
            }
            return [this["@id"], l, p, "0", m].join("/")
        },
        __testonly__: {
            canBeTiled: c,
            constructLevels: u
  ...
  ! function(h) {
    h.TmsTileSource = function(e, t, i, n, o) {
        ...
        var s, a = 256 * Math.ceil(r.width / 256),
  ...
  ! function(l) {
    ...
    l.extend(l.LegacyTileSource.prototype, l.TileSource.prototype, {
        ...
        configure: function(e, t) {
            return l.isPlainObject(e) ? e.levels : function(e, t) {
  ...
  ! function(o) {
    ...
    o.Button = function(e) {
        ...
        if (!e.element) {
            ...
            o.setElementPointerEventsNone(this.imgRest);
            o.setElementPointerEventsNone(this.imgGroup);
            o.setElementPointerEventsNone(this.imgHover);
            o.setElementPointerEventsNone(this.imgDown);
            this.element.style.position = "relative";
  ...
  ! function(P) {
    ...
    P.Rect.fromSummits = function(e, t, i) {
        var n = e.distanceTo(t);
        var o = e.distanceTo(i);
        var r = t.minus(e);
        var s = Math.atan(r.y / r.x);
        r.x < 0 ? s += Math.PI : r.y < 0 && (s += 2 * Math.PI);
        return new P.Rect(e.x, e.y, n, o, s / Math.PI * 180)
    };
    P.Rect.prototype = {
        clone: function() {
            return new P.Rect(this.x, this.y, this.width, this.height, this.degrees)
        },
        getAspectRatio: function() {
            return this.width / this.height
        },
        getTopLeft: function() {
            return new P.Point(this.x, this.y)
        },
        getBottomRight: function() {
            return new P.Point(this.x + this.width, this.y + this.height).rotate(this.degrees, this.getTopLeft())
        },
        getTopRight: function() {
            return new P.Point(this.x + this.width, this.y).rotate(this.degrees, this.getTopLeft())
        },
        getBottomLeft: function() {
            return new P.Point(this.x, this.y + this.height).rotate(this.degrees, this.getTopLeft())
        },
        getCenter: function() {
            return new P.Point(this.x + this.width / 2, this.y + this.height / 2).rotate(this.degrees, this.getTopLeft())
        },
        getSize: function() {
            return new P.Point(this.width, this.height)
        },
        equals: function(e) {
            return e instanceof P.Rect && this.x === e.x && this.y === e.y && this.width === e.width && this.height === e.height && this.degrees === e.degrees
        },
        times: function(e) {
            return new P.Rect(this.x * e, this.y * e, this.width * e, this.height * e, this.degrees)
        },
        translate: function(e) {
            return new P.Rect(this.x + e.x, this.y + e.y, this.width, this.height, this.degrees)
        },
        union: function(e) {
            ...
            for (var p = 0; p < u.length; p++) {
                ...
                for (var v = 0; v < d.length; v++) {
                    ...
                    var f = function(e, t, i, n) {
                        ...
                        if (-h <= a && a <= 1 - h && -h <= l && l <= 1 - h) return new P.Point(e.x + l * o.x, e.y + l * o.y);
                        return null
                    }(g[0], g[1], m[0], m[1]);
                    f && t.push(f)
                }
        ...
        rotate: function(e, t) {
            if (0 === (e = P.positiveModulo(e, 360))) return this.clone();
            t = t || this.getCenter();
            ...
            return new P.Rect(i.x, i.y, this.width, this.height, o / Math.PI * 180)
        },
  ...
  ! function(u) {
    var s = {};
    u.ReferenceStrip = function(e) {
        var t, i, n, o = e.viewer,
            r = u.getElementSize(o.element);
        if (!e.id) {
            e.id = "referencestrip-" + u.now();
            this.element = u.makeNeutralElement("div");
            this.element.id = e.id;
            this.element.className = "referencestrip"
        }
        e = u.extend(!0, {
            sizeRatio: u.DEFAULT_SETTINGS.referenceStripSizeRatio,
            position: u.DEFAULT_SETTINGS.referenceStripPosition,
            scroll: u.DEFAULT_SETTINGS.referenceStripScroll,
            clickTimeThreshold: u.DEFAULT_SETTINGS.clickTimeThreshold
        }, e, {
            element: this.element
        });
        u.extend(this, e);
        ...
        i.background = "#000";
        i.position = "relative";
        u.setElementTouchActionNone(this.element);
        u.setElementOpacity(this.element, .8);
        this.viewer = o;
        this.tracker = new u.MouseTracker({
            userData: "ReferenceStrip.tracker",
            element: this.element,
            clickHandler: u.delegate(this, a),
            dragHandler: u.delegate(this, l),
            scrollHandler: u.delegate(this, h),
            enterHandler: u.delegate(this, d),
            leaveHandler: u.delegate(this, p),
            keyDownHandler: u.delegate(this, g),
            keyHandler: u.delegate(this, v),
            preProcessEventHandler: function(e) {
                "wheel" === e.eventType && (e.preventDefault = !0)
            }
        });
        if (e.width && e.height) {
            ...
            o.addControl(this.element, {
                anchor: u.ControlAnchor.BOTTOM_LEFT
            })
            ...
            o.addControl(this.element, {
                anchor: u.ControlAnchor.TOP_LEFT
            })
        }
        ...
        for (n = 0; n < o.tileSources.length; n++) {
            (t = u.makeNeutralElement("div")).id = this.element.id + "-" + n;
            ...
            t.style.padding = "2px";
            u.setElementTouchActionNone(t);
            u.setElementPointerEventsNone(t);
            this.element.appendChild(t);
            t.activePanel = !1;
            this.panels.push(t)
        }
        c(this, "vertical" === this.scroll ? r.y : r.x, 0);
        this.setFocus(0)
    };
    u.ReferenceStrip.prototype = {
        setFocus: function(e) {
            var t, i = this.element.querySelector("#" + this.element.id + "-" + e),
                n = u.getElementSize(this.viewer.canvas),
        ...
        update: function() {
            if (s[this.id].animating) {
                u.console.log("image reference strip update");
                return !0
            }
            return !1
        },
    ...
    function a(e) {
        if (e.quick) {
            var t;
            t = "horizontal" === this.scroll ? Math.floor(e.position.x / this.panelWidth) : Math.floor(e.position.y / this.panelHeight);
    ...
    function l(e) {
        ...
        if (this.element) {
            var t = Number(this.element.style.marginLeft.replace("px", "")),
                ...
                r = u.getElementSize(this.viewer.canvas);
            if ("horizontal" === this.scroll) {
                if (0 < -e.delta.x) {
                    if (t > -(n - r.x)) {
                        this.element.style.marginLeft = t + 2 * e.delta.x + "px";
                        c(this, r.x, t + 2 * e.delta.x)
                    }
    ...
    function c(e, t, i) {
        ...
        o = Math.ceil(t / n) + 5;
        for (a = o = (o = (r = Math.ceil((Math.abs(i) + t) / n) + 1) - o) < 0 ? 0 : o; a < r && a < e.panels.length; a++)
            if (!(l = e.panels[a]).activePanel) {
                var h;
                var c = e.viewer.tileSources[a];
                ...
                u.setElementPointerEventsNone(s.canvas);
                u.setElementPointerEventsNone(s.container);
                s.innerTracker.setTracking(!1);
                s.outerTracker.setTracking(!1);
                e.miniViewers[l.id] = s;
                l.activePanel = !0
            }
    }
    ...
    function p(e) {
        var t = e.eventSource.element;
        "horizontal" === this.scroll ? t.style.marginBottom = "-" + u.getElementSize(t).y / 2 + "px" : t.style.marginLeft = "-" + u.getElementSize(t).x / 2 + "px"
    }
  ...
  ! function(h) {
    ...
    h.Tile.prototype = {
        ...
        drawCanvas: function(e, t, i, n) {
            var o, r = this.position.times(h.pixelDensityRatio),
            ...
            if (this.context2D || this.cacheImageRecord) {
                ...
                if (this.loaded && o) {
                    ...
                    e.translate(r.x + s.x / 2, 0);
                    this.flipped && e.scale(-1, 1);
                    e.drawImage(o.canvas, 0, 0, a, l, -s.x / 2, r.y, s.x, s.y);
                    e.restore()
                } else h.console.warn("Attempting to draw tile %s when it's not yet loaded.", this.toString())
  ...
  ! function(c) {
    ...
    c.Overlay.prototype = {
        ...
        drawHTML: function(e, t) {
            ...
            var s = n.rotate;
            if (this.onDraw) this.onDraw(o, r, this.element);
            else {
                var a = this.style;
                a.left = o.x + "px";
                a.top = o.y + "px";
        ...
        _getOverlayPositionAndSize: function(e) {
            ...
            this.adjust(t, i);
            var n = 0;
            if (e.degrees && this.rotationMode !== c.OverlayRotationMode.NO_ROTATION)
                if (this.rotationMode === c.OverlayRotationMode.BOUNDING_BOX && null !== this.width && null !== this.height) {
  ...
  ! function(u) {
    u.Drawer = function(e) {
        ...
        u.setElementPointerEventsNone(this.canvas);
        u.setElementTouchActionNone(this.canvas);
    ...
    p.Viewport.prototype = {
        ...
        viewportToImageCoordinates: function(e, t) {
            ...
            if (this.viewer) {
                ...
                if (1 < i) p.console.error("[Viewport.viewportToImageCoordinates] is not accurate with multi-image; use TiledImage.viewportToImageCoordinates instead.");
                else if (1 === i) {
        ...
        imageToViewportCoordinates: function(e, t) {
            ...
            if (this.viewer) {
                var i = this.viewer.world.getItemCount();
                if (1 < i) p.console.error("[Viewport.imageToViewportCoordinates] is not accurate with multi-image; use TiledImage.imageToViewportCoordinates instead.");
                else if (1 === i) {
        ...
        imageToViewportRectangle: function(e, t, i, n) {
            ...
            if (this.viewer) {
                ...
                if (1 < r) p.console.error("[Viewport.imageToViewportRectangle] is not accurate with multi-image; use TiledImage.imageToViewportRectangle instead.");
                else if (1 === r) {
        ...
        viewportToImageRectangle: function(e, t, i, n) {
            ...
            if (this.viewer) {
                var r = this.viewer.world.getItemCount();
                if (1 < r) p.console.error("[Viewport.viewportToImageRectangle] is not accurate with multi-image; use TiledImage.viewportToImageRectangle instead.");
                else if (1 === r) {
        ...
        viewportToImageZoom: function(e) {
            if (this.viewer) {
                ...
                if (1 < t) p.console.error("[Viewport.viewportToImageZoom] is not accurate with multi-image.");
                else if (1 === t) {
        ...
        imageToViewportZoom: function(e) {
            if (this.viewer) {
                var t = this.viewer.world.getItemCount();
                if (1 < t) p.console.error("[Viewport.imageToViewportZoom] is not accurate with multi-image.");
                else if (1 === t) {
  ...
  ! function(T) {
    T.TiledImage = function(e) {
        var t = this;
        T.console.assert(e.tileCache, "[TiledImage] options.tileCache is required");
        T.console.assert(e.drawer, "[TiledImage] options.drawer is required");
        T.console.assert(e.viewer, "[TiledImage] options.viewer is required");
        T.console.assert(e.imageLoader, "[TiledImage] options.imageLoader is required");
        T.console.assert(e.source, "[TiledImage] options.source is required");
        T.console.assert(!e.clip || e.clip instanceof T.Rect, "[TiledImage] options.clip must be an OpenSeadragon.Rect if present");
        T.EventSource.call(this);
        ...
        e.clip instanceof T.Rect && (this._clip = e.clip.clone());
        delete e.clip;
        var i = e.x || 0;
        delete e.x;
        var n = e.y || 0;
        ...
        if (e.width) {
            ...
            delete e.width;
            if (e.height) {
                T.console.error("specifying both width and height to a tiledImage is not supported");
                delete e.height
            }
        } else if (e.height) {
        ...
        this._drawingHandler = function(e) {
            t.viewer.raiseEvent("tile-drawing", T.extend({
                tiledImage: t
            }, e))
        }
    };
    T.extend(T.TiledImage.prototype, T.EventSource.prototype, {
        ...
        getWorldBounds: function() {
            T.console.error("[TiledImage.getWorldBounds] is deprecated; use TiledImage.getBounds instead");
        ...
        getClippedBounds: function(e) {
            ...
            if (this._clip) {
                ...
                t = new T.Rect(t.x + n.x, t.y + n.y, n.width, n.height)
            }
        ...
        getTileBounds: function(e, t, i) {
            ...
            var o = (n.x + t % n.x) % n.x;
            var r = (n.y + i % n.y) % n.y;
            var s = this.source.getTileBounds(e, o, r);
            this.getFlip() && (s.x = 1 - s.x - s.width);
            s.x += (t - o) / n.x;
            s.y += this._worldHeightCurrent / this._worldWidthCurrent * ((i - r) / n.y);
            return s
        },
        ...
        getSizeInWindowCoordinates: function() {
            var e = this.imageToWindowCoordinates(new T.Point(0, 0));
        ...
        _viewportToImageDelta: function(e, t, i) {
            ...
            return new T.Point(e * (this.source.dimensions.x / n), t * (this.source.dimensions.y * this.contentAspectX / n))
        },
        viewportToImageCoordinates: function(e, t, i) {
            var n;
            if (e instanceof T.Point) {
                i = t;
                n = e
            } else n = new T.Point(e, t);
        ...
        imageToViewportRectangle: function(e, t, i, n, o) {
            var r = e;
            r instanceof T.Rect ? o = t : r = new T.Rect(e, t, i, n);
            var s = this.imageToViewportCoordinates(r.getTopLeft(), o);
            var a = this._imageToViewportDelta(r.width, r.height, o);
            return new T.Rect(s.x, s.y, a.x, a.y, r.degrees + this.getRotation(o))
        },
        viewportToImageRectangle: function(e, t, i, n, o) {
            var r = e;
            e instanceof T.Rect ? o = t : r = new T.Rect(e, t, i, n);
        ...
        _viewportToTiledImageRectangle: function(e) {
            ...
            return new T.Rect((e.x - this._xSpring.current.value) / t, (e.y - this._ySpring.current.value) / t, e.width / t, e.height / t, e.degrees)
        },
        viewportToImageZoom: function(e) {
        ...
        setCroppingPolygons: function(e) {
            function t(e) {
                return e.map(function(e) {
                    try {
                        if ((t = e) instanceof T.Point || "number" == typeof t.x && "number" == typeof t.y) return {
                            x: e.x,
                            y: e.y
                        };
                        throw new Error
            ...
            try {
                if (!T.isArray(e)) throw new Error("Provided cropping polygon is not an array");
                this._croppingPolygons = e.map(t)
            } catch (e) {
                T.console.error("[TiledImage.setCroppingPolygons] Cropping polygon format not supported");
                T.console.error(e);
        ...
        fitBounds: function(e, t, i) {
            t = t || T.Placement.CENTER;
            var n = T.Placement.properties[t];
            ...
            if (e.getAspectRatio() > o) {
                ...
                this.setPosition(new T.Point(e.x - r + c, e.y - s), i);
                this.setHeight(h, i)
            } else {
                var u = e.width / a;
                var d = 0;
                n.isVerticallyCentered ? d = (e.height - e.width / o) / 2 : n.isBottom && (d = e.height - e.width / o);
                this.setPosition(new T.Point(e.x - r, e.y - s + d), i);
                this.setWidth(u, i)
            }
        },
        getClip: function() {
        ...
        setClip: function(e) {
            T.console.assert(!e || e instanceof T.Rect, "[TiledImage.setClip] newClip must be an OpenSeadragon.Rect or null");
            e instanceof T.Rect ? this._clip = e.clone() : this._clip = null;
            this._needsDraw = !0;
        ...
        _updateViewport: function() {
            ...
            for (var h = r; o <= h; h--) {
                ...
                if (h === o || !a && u >= this.minPixelRatio) a = c = !0;
                else if (!a) continue;
                ...
                s = function(e, t, i, n, o, r, s, a, l) {
                    ...
                    P(e.coverage, n);
                    P(e.loadingCoverage, n);
                    var u = e._getCornerTiles(n, h, c);
                    var d = u.topLeft;
                    var p = u.bottomRight;
                    var g = e.source.getNumTiles(n);
                    var v = e.viewport.pixelFromPoint(e.viewport.getCenter());
                    if (e.getFlip()) {
                        p.x += 1;
                        e.wrapHorizontal || (p.x = Math.min(p.x, g.x - 1))
                    }
                    for (var m = d.x; m <= p.x; m++)
                        for (var f = d.y; f <= p.y; f++) {
                            var y;
                            if (e.getFlip()) {
                                var w = (g.x + m % g.x) % g.x;
                                y = m + g.x - w - w - 1
                            } else y = m;
                            null !== s.intersection(e.getTileBounds(n, y, f)) && (l = function(e, t, i, n, o, r, s, a, l, h, c, u) {
                                var d = function(e, t, i, n, o, r, s, a) {
                                        var l, h, c, u, d, p, g, v, m;
                                        r[i] || (r[i] = {});
                                        r[i][e] || (r[i][e] = {});
                                        if (!r[i][e][t] || !r[i][e][t].flipped != !n.flipped) {
                                            l = (a.x + e % a.x) % a.x;
                                            h = (a.y + t % a.y) % a.y;
                                            c = n.getTileBounds(i, e, t);
                                            u = o.getTileBounds(i, l, h, !0);
                                            d = o.tileExists(i, l, h);
                                            p = o.getTileUrl(i, l, h);
                                            if (n.loadTilesWithAjax) {
                                                g = o.getTileAjaxHeaders(i, l, h);
                                                T.isPlainObject(n.ajaxHeaders) && (g = T.extend({}, n.ajaxHeaders, g))
                                            } else g = null;
                                            v = o.getContext2D ? o.getContext2D(i, l, h) : void 0;
                                            m = new T.Tile(i, e, t, c, d, p, v, n.loadTilesWithAjax, g, u);
                                            n.getFlip() ? 0 == l && (m.isRightMost = !0) : l == a.x - 1 && (m.isRightMost = !0);
                                            h == a.y - 1 && (m.isBottomMost = !0);
                                            m.flipped = n.flipped;
                                            r[i][e][t] = m
                                        }(m = r[i][e][t]).lastTouchTime = s;
                                        return m
                                ...
                                E(e.coverage, r, n, o, !1);
                                var g = d.loaded || d.loading || S(e.loadingCoverage, r, n, o);
                                E(e.loadingCoverage, r, n, o, g);
                                if (!d.exists) return u;
                                t && !p && (S(e.coverage, r, n, o) ? E(e.coverage, r, n, o, !0) : p = !0);
                                if (!p) return u;
                                ...
                                if (!d.loaded)
                                    if (d.context2D) x(e, d);
                                    else {
                                        var v = e._tileCache.getImageRecord(d.cacheKey);
                                        if (v) {
                                            var m = v.getImage();
                                            x(e, d, m)
                                        }
                                    } {
                                        d.loaded ? function(e, t, i, n, o, r, s) {
                                            ...
                                            e.lastDrawn.push(t);
                                            if (1 === l) {
                                                E(e.coverage, o, i, n, !0);
                                                e._hasOpaqueTile = !0
                                            } else if (a < h) return !0;
                                            return !1
                                        }(e, d, n, o, r, s, c) && (e._needsDraw = !0) : d.loading ? e._tilesLoading++ : g || (u = function(e, t) {
                                            if (!e) return t; {
                                ...
                                return u
                            }(e, i, t, y, f, n, o, r, v, g, a, l))
                        }
                    return l
                }(this, a, c, h, Math.min(1, (u - .5) / .5), g / Math.abs(g - d), t, l, s);
                if (v(this.coverage, h)) break
            }! function(n, e) {
                ...
                if (1 < e.length && a > n.smoothTileEdgesMinZoom && !n.iOSDevice && n.getRotation(!0) % 360 == 0 && T.supportsCanvas) {
                    i = !0;
                    ...
                    n._imageLoader.addJob({
                        ...
                        callback: function(e, t, i) {
                            ! function(t, i, e, n, o, r) {
                                if (!n) {
                                    T.console.log("Tile %s failed to load: %s - error: %s", i, i.url, o);
                                ...
                                if (e < t.lastResetTime) {
                                    T.console.log("Ignoring tile %s loaded before reset: %s", i, i.url);
                                    i.loading = !1;
                                    return
                                }
        ...
        _getCornerTiles: function(e, t, i) {
            ...
            var o;
            if (this.wrapHorizontal) {
                n = T.positiveModulo(t.x, 1);
                o = T.positiveModulo(i.x, 1)
            } else {
                n = Math.max(0, t.x);
                o = Math.min(1, i.x)
            }
            ...
            if (this.wrapVertical) {
                r = T.positiveModulo(t.y, a);
                s = T.positiveModulo(i.y, a)
            } else {
                r = Math.max(0, t.y);
                s = Math.min(a, i.y)
            }
            var l = this.source.getTileAtPoint(e, new T.Point(n, r));
            var h = this.source.getTileAtPoint(e, new T.Point(o, s));
    ...
    function S(e, t, i, n) {
        return void 0 === i || void 0 === n ? v(e, t + 1) : v(e, t + 1, 2 * i, 2 * n) && v(e, t + 1, 2 * i, 2 * n + 1) && v(e, t + 1, 2 * i + 1, 2 * n) && v(e, t + 1, 2 * i + 1, 2 * n + 1)
    }
    ...
    function E(e, t, i, n, o) {
        if (e[t]) {
            e[t][i] || (e[t][i] = {});
            e[t][i][n] = o
        } else T.console.warn("Setting coverage for a tile before its level's coverage has been reset: %s", t)
    }
    ...
    g.TileCache.prototype = {
        ...
        cacheTile: function(e) {
            ...
            if (!n) {
                ...
                n = this._imagesLoaded[e.tile.cacheKey] = new m({
                    image: e.image
                });
  ...
  ! function(m) {
    m.World = function(e) {
        var t = this;
        m.console.assert(e.viewer, "[World] options.viewer is required");
    ...
    m.extend(m.World.prototype, m.EventSource.prototype, {
        addItem: function(e, t) {
            m.console.assert(e, "[World.addItem] item is required");
            m.console.assert(e instanceof m.TiledImage, "[World.addItem] only TiledImages supported at this time");
            if (void 0 !== (t = t || {}).index) {
        ...
        getItemAt: function(e) {
            m.console.assert(void 0 !== e, "[World.getItemAt] index is required");
            return this._items[e]
        },
        getIndexOfItem: function(e) {
            m.console.assert(e, "[World.getIndexOfItem] item is required");
            return m.indexOf(this._items, e)
        },
        getItemCount: function() {
            return this._items.length
        },
        setItemIndex: function(e, t) {
            m.console.assert(e, "[World.setItemIndex] item is required");
            m.console.assert(void 0 !== t, "[World.setItemIndex] index is required");
        ...
        removeItem: function(e) {
            m.console.assert(e, "[World.removeItem] item is required");
            var t = m.indexOf(this._items, e);
            if (-1 !== t) {
        ...
        arrange: function(e) {
            ...
            var i = e.layout || m.DEFAULT_SETTINGS.collectionLayout;
            var n = e.rows || m.DEFAULT_SETTINGS.collectionRows;
            var o = e.columns || m.DEFAULT_SETTINGS.collectionColumns;
            var r = e.tileSize || m.DEFAULT_SETTINGS.collectionTileSize;
            var s = r + (e.tileMargin || m.DEFAULT_SETTINGS.collectionTileMargin);
            var a;
            ...
            for (var v = 0; v < this._items.length; v++) {
                ...
                p = (d = (u = (c = this._items[v]).getBounds()).width > u.height ? r : r * (u.width / u.height)) * (u.height / u.width);
                g = new m.Point(l + (r - d) / 2, h + (r - p) / 2);
                c.setPosition(g, t);
                c.setWidth(d, t);
        ...
        _figureSizes: function() {
            ...
            if (this._items.length) {
                ...
                this._homeBounds = new m.Rect(s, a, l - s, h - a);
                this._contentSize = new m.Point(this._homeBounds.width * this._contentFactor, this._homeBounds.height * this._contentFactor)
            } else {
                this._homeBounds = new m.Rect(0, 0, 1, 1);
                this._contentSize = new m.Point(1, 1);
